...
public class DamageCalculationTest {
    ...
    public void FireElf_ability() {
        ...
        Card card1 = new Card("1",CardName1,CardDamage1, cardManager.createMonsterType(CardName1), cardManager.createElementType(CardName1));
        Card card2 = new Card("2",CardName2,CardDamage2, cardManager.createMonsterType(CardName2), cardManager.createElementType(CardName2));
    ...
    public void WaterSpell_ability() {
        ...
        float damage = 50;
        Card card1 = new Card("1",CardName1,damage, cardManager.createMonsterType(CardName1), cardManager.createElementType(CardName1));
        Card card2 = new Card("2",CardName2,damage, cardManager.createMonsterType(CardName2), cardManager.createElementType(CardName2));
        Card card3 = new Card("2",CardName3,damage, cardManager.createMonsterType(CardName3), cardManager.createElementType(CardName3));
        CombatManager manager = CombatManager.getInstance();
        float result1 = manager.calculateDamage(card1,card2);
